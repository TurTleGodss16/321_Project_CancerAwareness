  ...
  const AboutScreen = () => {
    ...
    return (
      <View style={styles.body}>
          <TouchableHighlight onPress={() => navigation.navigate('AboutApp')} underlayColor="#EAE6E6">
          ...
          <TouchableHighlight onPress={() => navigation.navigate('AboutPartners')} underlayColor="#EAE6E6">
            <View style={styles.containers}>
                <View>
                    <Image
                        style={styles.image_custom_aboutpartners}
          ...
          <TouchableHighlight onPress={() => navigation.navigate('AboutDevelopment')} underlayColor="#EAE6E6">
            <View style={styles.containers}>
                <View>
                    <Image
                        style={styles.image_custom_aboutpartners}
